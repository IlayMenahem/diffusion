...
class mnist_generator(eqx.Module):
    ...
    def __init__(self, key):
        ...
        self.conv2 = eqx.nn.ConvTranspose2d(32, 16, 3, 1, padding=1, key=key4)
        self.conv3 = eqx.nn.ConvTranspose2d(16, 1, 3, 1, padding=1, key=key5)
